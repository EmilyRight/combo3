...
class ApiService {
  constructor() {
    ...
    const tariffsPath = `.tele2.ru/api/shop/products/devices/bundles/?siteId=${siteId}&category=smartphones&promoCampaignId=${promoCampaignId}&bundleIndex=1&bundleSize=1000`;
